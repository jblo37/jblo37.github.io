...
.then(datos => {
    ...
    const jugadorPuntosNombre = jugadores.map(jugador => 
        ...
        .then(jugadorPuntos => ({
            ...
            puntos: jugadorPuntos.progress.Royals_2v2_2025.trophies,
            puntosM: jugadorPuntos.progress.Royals_2v2_2025.bestTrophies
        }))
        ...
        if (jugador.puntos > 29) {
            listaElementos.innerHTML = `
                <div class="row justify-content-start align-items-center">
                    ...
                    <div class="col-1 text-end">
                        <img src="../assets/brand/trophy-2v2.webp" style="width:26px; height:auto;">
                    </div>
            ...
            listaElementos.innerHTML = `
                <div class="row justify-content-start align-items-center">
                    ...
                    <div class="col-1 text-end">
                        <img src="../assets/brand/2v2-puntos.png" style="width:24px; height:auto;">
                    </div>
                    <div class="col-2 align-items-center">
                        <div class="row">
                            <span class="text-warning text-left">${jugador.puntos}</span>
